...
fname = join_path(root_path, 'jena_climate_2009_2016.csv')
f = open(fname)
data = f.read()
f.close()
...
def evaluate_naive_method():
    ...
    batch_maes_mean = np.mean(batch_maes)
    return batch_maes_mean

batch_maes_mean = evaluate_naive_method()
print(batch_maes_mean)
celsius_mae = batch_maes_mean * std[1]
print(celsius_mae)
